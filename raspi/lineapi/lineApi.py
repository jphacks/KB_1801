...
# alartしたい日時
alartdt = userDatetime()
alartdt.day = 1 # on 1st every Month
alartdt.weekday = 0 # Every Monday (Mon-Sun = 0-6)
alartdt.hour = 9 # at 9 everyday

# alart通知 ########################################
flag = 1
err = 0
dateNow = datetime.datetime.now()
flag, err = flagReport(dateNow, "d", alartdt, flag, err)
# flag = 1

if flag == 1:
    push.doPush("Alart: Clean Yout Desk!!")
